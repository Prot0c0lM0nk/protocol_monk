...
class UnifiedGuidanceSystem:
    ...
    def get_guidance(self, intent: str, context_tags: set, model_name: str = "large") -> Tuple[str, Dict]:
        ...
        formatted = self._format_guidance(intent, risks, facts, profile.guidance_style, model_name)
        return formatted, {"model": model_name, "profile": profile.name, "risks": len(risks), "facts": len(facts)}
