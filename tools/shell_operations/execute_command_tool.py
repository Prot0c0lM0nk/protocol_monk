...
class ExecuteCommandTool(BaseTool):
    ...
    def _is_safe_simple_command(self, command: str) -> bool:
        ...
        SIMPLE_COMMANDS = [
            ...
            'git', 'python', 'python3', 'pip', 'pip3', 'bandit',
            'radon', 'flake8', 'pylint', 'mypy', 'tokei', 'rg', 'fd'
        ]
    ...
    def execute(self, **kwargs) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                ...
                {"error_type": "PermissionError", "command": command, "details": str(e)}
            )
        except FileNotFoundError as e:
            return ToolResult(
                ExecutionStatus.EXTERNAL_ERROR,
                f"Command not found: {str(e)}",
                {"error_type": "FileNotFoundError", "command": command, "details": str(e)}
            )
