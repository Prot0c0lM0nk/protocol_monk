...
async def run_visual_audit():
    ...
    print("\n--- TEST 4: TOOL RESULT ---")
    res = ToolResult(success=True, output="File list retrieved.\nFound: agent.py", tool_name="list_files")
    await bus.emit(AgentEvents.TOOL_RESULT.value, {"tool_name": "list_files", "result": res})
