...
class TextualBridge(UI):
    ...
    async def display_tool_call(self, tool_call, auto_confirm=False): pass
    async def display_tool_result(self, result, tool_name): pass
    ...
    async def print_warning(self, message): pass
