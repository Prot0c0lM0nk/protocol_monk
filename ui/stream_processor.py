...
class StreamProcessor:
    ...
    def feed(self, chunk: str):
        """Append a chunk of data to the buffer with size checking."""
    ...
    def tick(self):
        ...
        if match:
            ...
            if len(buffer_content) > self.SAFETY_MARGIN:
                ...
                self._remove_from_buffer(safe_len)

    def _remove_from_buffer(self, chars_to_remove: int):
        """Remove characters from the front of the deque buffer."""
