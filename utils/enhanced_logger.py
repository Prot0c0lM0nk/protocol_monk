...
class EnhancedLogger:
    ...
    def __init__(self, log_dir: Path = None):
        ...
        try:
            ...
            print(f"!! CRITICAL: EnhancedLogger cannot create directories: {e}", file=sys.stderr)
    ...
    def log_tool_execution(self, tool_name: str, params: Dict, result: str, success: bool):
        self._write_entry("tool_execution", 
    ...
    def log_context_snapshot(self, messages: List[Dict]):
        ...
        """
        snapshot_file = self.context_snapshot_dir / f"ctx_{self.conversation_counter:03d}_{int(time.time())}.txt"
