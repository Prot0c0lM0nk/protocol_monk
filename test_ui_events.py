...
async def test_all_events():
    ...
    print("🚀 Starting comprehensive event system test (PlainUI)...")
    ...
    test_events = [
        ...
        (
            ...
            {"tool_name": "test_tool", "error": "Connection timeout"},
        ),
        (
            AgentEvents.TOOL_RESULT,
            {"tool_name": "test_tool", "result": "**Bold Result** from tool"},
        ),
        # Stream events
        ...
        (
            ...
            {"response": "Test response complete", "metadata": {"tokens": 120}},
        ),
        # Context events
